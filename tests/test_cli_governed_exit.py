...
from container_host_aiops.cli._common import checked

CLI_DIR = pathlib.Path(__file__).resolve().parents[1] / "container_host_aiops" / "cli"
...
CHECKERS = ['checked', 'dry_run_result']
